...
const pagesRoutes: Routes = [
    {
        ...
        canActivate: [ VerificaTokenGuard ], // Se coloca en todas las páginas que sean necesarias la renovación del Token
    ...
    // Mantenimientos
    {
        ...
        canActivate: [ AdminGuard ], // solo para usuarios administradores
